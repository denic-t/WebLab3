...
<img alt="homelander" height="200" src="./resources/homelander.gif"/>

# Лабораторная работа: Веб-приложение на базе сервлетов и JSP

Разработать веб-приложение на базе сервлетов и JSP, определяющее попадание точки на координатной плоскости в заданную область.

### Параметры задания

<img alt="areas" height="350" src="./resources/areas.png" width="350"/>

*   **изменение X**: Checkbox `{-2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2}`
